...
# cargo el dataset
dataset <- fread("../4_create_past_variables/bank_data_with_variables.csv")
...
dataset2[ , clase_binaria := NULL ]
dataset2[ , clase_binaria_mixed := NULL ]
...
dataset[ , clase_binaria := NULL ]
dataset[ , clase_binaria_mixed := NULL ]
...
print(modelo_original$variable.importance)
...
entrega <- as.data.table(list(
    ...
    "Predicted" = as.integer(prediccion > 0.0025)
))
