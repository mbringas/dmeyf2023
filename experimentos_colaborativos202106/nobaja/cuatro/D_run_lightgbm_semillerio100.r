...
PARAM <- list()
PARAM$experimento <- "baseline_07_undersampling01_sinbm43_100seeds"
...
PARAM$finalmodel$optim$learning_rate <- 0.02046
PARAM$finalmodel$optim$feature_fraction <- 0.41733
PARAM$finalmodel$optim$min_data_in_leaf <- 106
PARAM$finalmodel$optim$num_leaves <- 962
