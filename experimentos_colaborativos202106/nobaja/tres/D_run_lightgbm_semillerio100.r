...
PARAM <- list()
PARAM$experimento <- "baseline_07_undersampling01_sinbm3_100seeds"
...
PARAM$finalmodel$optim$num_iterations <- 1567
PARAM$finalmodel$optim$learning_rate <- 0.0682495
PARAM$finalmodel$optim$feature_fraction <- 0.78084
PARAM$finalmodel$optim$min_data_in_leaf <- 5342
PARAM$finalmodel$optim$num_leaves <- 719
