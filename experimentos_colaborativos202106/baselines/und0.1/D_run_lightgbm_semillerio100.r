...
PARAM <- list()
PARAM$experimento <- "baseline_07_undersampling01_100seeds"
...
PARAM$finalmodel$optim$num_iterations <- 697
PARAM$finalmodel$optim$learning_rate <- 0.13821126
PARAM$finalmodel$optim$feature_fraction <- 0.5467867
PARAM$finalmodel$optim$min_data_in_leaf <- 3526
PARAM$finalmodel$optim$num_leaves <- 897
