...
PARAM <- list()
PARAM$experimento <- "baseline_07_undersampling03_100seeds"
...
PARAM$finalmodel$optim$learning_rate <- 0.0201285
PARAM$finalmodel$optim$feature_fraction <- 0.3980411
PARAM$finalmodel$optim$min_data_in_leaf <- 111
