...
con.execute("CREATE TABLE bank_data AS SELECT * FROM read_csv_auto('~/buckets/b1/datasets/competencia_03_without_zerocols.csv.gz');")
...
output_csv = '~/buckets/b1/datasets/competencia_03_quantile_features.csv.gz'
print("ESCRIBE")
