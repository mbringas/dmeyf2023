...
PARAM <- list()
PARAM$experimento <- "Kaggle_terera_modelo_2"
...
PARAM$finalmodel$optim$learning_rate <-  0.0805
PARAM$finalmodel$optim$feature_fraction <-  0.15277
PARAM$finalmodel$optim$min_data_in_leaf <- 11745 
PARAM$finalmodel$optim$num_leaves <- 406

PARAM$finalmodel$optim$feature_fraction_bynode <- 0.70677 
PARAM$finalmodel$optim$max_depth <-  43
PARAM$finalmodel$optim$bagging_fraction <- 0.7919 
PARAM$finalmodel$optim$pos_bagging_fraction <-  0.86444
PARAM$finalmodel$optim$neg_bagging_fraction <-  0.40518
