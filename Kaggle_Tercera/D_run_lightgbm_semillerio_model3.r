...
PARAM <- list()
PARAM$experimento <- "Kaggle_terera_modelo_3"
...
PARAM$finalmodel$optim$num_iterations <- 473
PARAM$finalmodel$optim$learning_rate <- 0.145649 
PARAM$finalmodel$optim$feature_fraction <- 0.5549488
PARAM$finalmodel$optim$min_data_in_leaf <- 15445
PARAM$finalmodel$optim$num_leaves <- 670

PARAM$finalmodel$optim$feature_fraction_bynode <- 0.9251987
PARAM$finalmodel$optim$max_depth <- 14
PARAM$finalmodel$optim$bagging_fraction <- 0.672077 
PARAM$finalmodel$optim$pos_bagging_fraction <-  0.7566
PARAM$finalmodel$optim$neg_bagging_fraction <- 0.1378
PARAM$finalmodel$optim$bagging_freq <- 10
