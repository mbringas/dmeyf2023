...
con.execute("CREATE TABLE bank_data AS SELECT * FROM read_csv_auto('~/buckets/b1/datasets/competencia_03_quantile_features.csv.gz');")
...
columns=["mcuenta_corriente_adicional","mcuenta_corriente","mcaja_ahorro","mcuentas_saldo","mprestamos_personales","mprestamos_prendarios",
...
columns=columns+["q_mrentabilidad","q_mrentabilidad_annual","q_mcomisiones","q_mactivos_margen","q_mpasivos_margen","q_mautoservicio",
		 "q_mtarjeta_visa_consumo","q_mtarjeta_master_consumo","q_mpayroll","q_mcuenta_debitos_automaticos",
		 "q_mcomisiones_mantenimiento","q_mcomisiones_otras"]
...
output_csv = '~/buckets/b1/datasets/competencia_03_historical_features2.csv.gz'
