...
PARAM <- list()
PARAM$experimento <- "Kaggle_terera_modelo_X1"XX
...
PARAM$finalmodel$optim$num_iterations <- 1756
PARAM$finalmodel$optim$learning_rate <- 0.03912
PARAM$finalmodel$optim$feature_fraction <-  0.9134
PARAM$finalmodel$optim$min_data_in_leaf <-  2094
PARAM$finalmodel$optim$num_leaves <- 21

PARAM$finalmodel$optim$feature_fraction_bynode <- 0.1478
PARAM$finalmodel$optim$max_depth <- 44
PARAM$finalmodel$optim$bagging_fraction <-  .5673
PARAM$finalmodel$optim$pos_bagging_fraction <- 0.944
PARAM$finalmodel$optim$neg_bagging_fraction <- 0.4309
PARAM$finalmodel$optim$bagging_freq <- 27
